...
const DESCRIPTIONS = {
  ...
  gumbel_lev: "Largest-extreme-value location–scale model — for maxima.",
  logistic: "Location–scale model with slightly heavy tails.",
  rayleigh: "Single-scale model; linearly rising hazard (Weibull with β = 2).",
  ...
  beta_geometric: "Geometric with unit-to-unit heterogeneity in the failure probability.",
  negative_binomial: "Discrete counts to failure; more dispersed than the Geometric.",
  poisson: "Counts of events in a fixed exposure — the classic count model.",
  ...
  logistic_ph: "Logistic baseline proportional-hazards model.",
  gumbel_ph: "Gumbel baseline proportional-hazards model.",
  ...
  logistic_aft: "Logistic baseline accelerated-failure-time model.",
  gumbel_aft: "Gumbel baseline accelerated-failure-time model.",
  ...
  logistic_po: "Logistic baseline proportional-odds model.",
  gumbel_po: "Gumbel baseline proportional-odds model.",
  ...
  logistic_ah: "Logistic baseline additive-hazards model.",
  gumbel_ah: "Gumbel baseline additive-hazards model.",
